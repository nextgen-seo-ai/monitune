...
; Собирает один setup.exe который ставит MSIX + сертификат + Windows App Runtime.
...
Source: "WindowsAppRuntime-x64.exe";          DestDir: "{app}"; Flags: ignoreversion
Source: "AppIcon.ico";                        DestDir: "{app}"; Flags: ignoreversion

[Run]
; 1. Установить Windows App Runtime (тихо, без перезагрузки)
Filename: "{app}\WindowsAppRuntime-x64.exe"; Parameters: "--quiet"; \
    StatusMsg: "Установка Windows App Runtime..."; \
    Flags: waituntilterminated runhidden

; 2. Импорт сертификата в Trusted Root и TrustedPeople
